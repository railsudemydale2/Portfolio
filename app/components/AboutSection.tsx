...
import christy_canyon_4 from "../../public/christy_canyon_4.jpeg";
        ...
        <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-10">
            <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-8">
                <h1 className="text-4xl lg:text-6xl">
                    Passionate versitile Lesbian Milf Web Developer who loves to create
                </h1>
